...
import { useWorkspaceChooserBoardMemberRestrictionAlertQuery } from './WorkspaceChooserBoardMemberRestrictionAlertQuery.generated';
...
export const BoardMemberRestrictionAlert: React.FunctionComponent<BoardMemberRestrictionAlertProps> = ({
  ...
  const { data, loading } = useWorkspaceChooserBoardMemberRestrictionAlertQuery(
    {
      variables: { orgId },
    },
  );
