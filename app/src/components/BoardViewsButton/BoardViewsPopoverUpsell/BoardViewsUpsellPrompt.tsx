...
export const BoardViewsUpsellPrompt: React.FC<OwnProps> = ({
  ...
  const onClickPrimary = useCallback(() => {
    ...
    Analytics.sendClickedButtonEvent({
      buttonName: isUpgrade ? 'upgradeToBCButton' : 'startFreeTrialButton',
  ...
  }, [boardId, orgId, orgName, isUpgrade, activateFreeTrial, hidePopover]);
      ...
      <section className={styles.ctaSection}>
        {!dontUpsell() && (
          <>
            {isUpgrade && !isAdmin ? (
              <p>
                {getSectionText('bc-trial-prompt', 'contact-workspace-admin')}
              </p>
            ) : (
              <Button
                appearance="primary"
