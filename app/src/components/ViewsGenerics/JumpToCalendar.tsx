...
import { PaginationContext } from 'app/src/components/BoardCalendarView/PaginationContext';
...
export const JumpToCalendar: React.FunctionComponent<JumpToCalendarProps> = ({
  ...
  const { fetchCardsInNewRange } = useContext(PaginationContext);

  useEffect(() => {
    fetchCardsInNewRange(visibleMonth);
  }, [visibleMonth, fetchCardsInNewRange]);
