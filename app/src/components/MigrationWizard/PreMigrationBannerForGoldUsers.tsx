...
export const PreMigrationBannerForGoldUsers: React.FC<MigrationWizardBannerProps> = () => {
  ...
  const {
    isEligibleMember: isGoldUserEligibleForFreeTrial,
  } = useMyGoldPromoFreeTrial(); // Don't show PreMigration banner if Gold Premium Free Trial Banner is active
  ...
  return !isGoldUserEligibleForFreeTrial ? (
