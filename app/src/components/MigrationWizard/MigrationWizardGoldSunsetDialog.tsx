      ...
      <div className={styles.body}>
        ...
        <div className={styles.explanation}>
          <img
            alt=""
            className={styles.featureIcon}
            src={require('resources/images/teamify/crownIcon.svg')}
          />
          <p>
        ...
        <div className={styles.explanation}>
          ...
          />
          <p>
            <b>{format('gold-promo-dialog-60-days-and-discount-title')}</b>
            <br />
            {format('gold-promo-dialog-60-days-and-discount-description')}
          </p>
        </div>

        <p className={styles.paragraph}>
          {format('gold-promo-dialog-post-text')}
        </p>
      </div>
