...
import { BoardsSearch } from 'app/src/components/BoardsMenu/BoardsSearch';
import {
  getBoardsMenuFilteredBoards,
  getBoardsMenu,
} from 'app/gamma/src/selectors/boards';
import { BoardsMenuVisibilityState } from 'app/src/components/BoardsMenu/useBoardsMenuVisibility';
import { Key, Scope, useShortcut } from '@trello/keybindings';
import styles from './QuickSwitcher.less';
import { noop } from 'app/src/noop';

export const QuickSwitcher: FunctionComponent = () => {
  const { filteredBoards, selectedBoard, visibleBoards } = useSelector(
    (state: State) => {
