...
import styles from './AccountSwitcherMenuPopover.less';
...
interface AccountSwitcherMenuProps extends AccountSwitcherMenuDispatchProps {}

export const AccountSwitcherMenuPopover: React.FunctionComponent<AccountSwitcherMenuProps> = ({
  onClickAddAccount,
  hasAaAccount,
}) => {
  const me = useSelector((state: State) => getMe(state));
