...
import { forceMigrationQuery } from 'app/src/components/AtlassianAccountMigration/AtlassianAccountMigrationBanner';
import {
  forceActiveMigrationQuery,
  forceEnterpriseMigrationQuery,
  forceInactiveMigrationQuery,
} from 'app/src/components/AtlassianAccountMigration/AtlassianAccountMigrationConfirmation';

import {
  useAtlassianAccountMigrationBanner,
  useAtlassianAccountMigrationConfirmation,
} from 'app/src/components/AtlassianAccountMigration';
import {
...
export const useAtlassianAccountMigrationStageBanners = () => {
  ...
  const {
    shouldRender: shouldRenderAtlassianAccountMigrationConfirmation,
  } = useAtlassianAccountMigrationConfirmation();
  ...
  useEffect(() => {
    ...
    } else if (forceEnterpriseMigrationQuery.test(query)) {
      setForceStage(Stage.enterpriseMigration);
