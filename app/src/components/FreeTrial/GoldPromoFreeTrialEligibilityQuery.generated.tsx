...
export type GoldPromoFreeTrialEligibilityQuery = (
  ...
  & { member?: Types.Maybe<(
    { __typename: 'Member' }
    & Pick<Types.Member, 'id' | 'confirmed' | 'idEnterprise' | 'goldSunsetFreeTrialIdOrganization'>
    & { boards: Array<(
      { __typename: 'Board' }
      ...
      { __typename: 'PaidAccount' }
      & Pick<Types.PaidAccount, 'products' | 'standing'>
