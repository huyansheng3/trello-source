...
import { useStandardPremiumFreeTrial } from 'app/src/components/BillingDetails/useStandardPremiumFreeTrial';
...
export const FreeTrialBannerActive: React.FC<FreeTrialBannerActiveProps> = ({
  ...
  const { isAutoUpgrade } = useStandardPremiumFreeTrial(orgId);
  ...
  const daysLeftText = ((localizeCount(
    isAutoUpgrade
      ? 'free-trial-banner-trial-ends-soon-auto-renewal'
