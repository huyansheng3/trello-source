...
class CardView extends View {
  ...
  render() {
    ...
    if (cardRole === 'separator') {
      ...
      // MirrorCards never shipped. This was the minimum safe change that could be made to remove the unnecessary page
      // weight to improve performance. The owning team should come back and remove mirror cards completely.
      // this.unmountReactCard = renderComponent(
