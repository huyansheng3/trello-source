...
const CardCopyView = require('app/scripts/views/card/card-copy-view');
    ...
    if (err) {
      ...
      Analytics.sendUpdatedCardFieldEvent({
        ...
        containers: {
          ...
          list: { id: card.idList },
          organization: { id: this.model?.getBoard()?.get('idOrganization') },
        },
        attributes: {
          taskId: traceId,
        },
...
class QuickCardEditorView extends View {
      ...
      case Key.Escape:
        ...
        Analytics.sendPressedShortcutEvent({
          ...
          containers: {
            ...
            board: { id: this.model?.idBoard },
            list: { id: this.model?.idList },
            organization: { id: this.model?.getBoard()?.get('idOrganization') },
          },
        });
  ...
  editLabels(e) {
    return this.showPopOver(e, CardLabelSelectView);
  }

  editMembers(e) {
    return this.showPopOver(e, CardMemberSelectView);
  }
  ...
  copyCard(e) {
    return this.showPopOver(e, CardCopyView, {
  ...
  editDueDate(e) {
    ...
    if (seeDateRangePicker) {
      ...
      this.showPopOver(e, DatePickerView);
    }
  }

  moveCard(e) {
    const onCommit = this.closeEditor.bind(this);
    return this.showPopOver(e, CardMoveView, { onCommit });
  }
