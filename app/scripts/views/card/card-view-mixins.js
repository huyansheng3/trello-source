...
const {
  titleForDueDate,
  classForDueDate,
  relativeInfoForStartDate,
} = require('@trello/dates');
...
const badgesTemplate = t.renderable(function ({
  ...
  const getDateBadge = (text) => {
    t.div(
      ...
      {
        title: titleForDueDate(due, dueComplete),
        class: t.classify({
          'mod-due-date': showDueCompleteCheckbox,
          [classForDueDate(due, dueComplete)]: true,
        }),
      },
      function () {
    ...
    if (start && due && start <= due) {
      ...
      t.div('.badge.js-start-date-badge', function () {
        ...
        t.span('.badge-text.js-start-date-text', function () {
          t.text(
            l(relativeInfoForStartDate(start, false), {
    ...
    t.div(
      '.badge.js-checkitems-badge',
      {
        ...
        class: t.classify({
          ...
          [classForDueDate(checkItemsEarliestDue, false)]:
...
module.exports = {
  ...
  updateDueDate() {
    ...
    if (badgeElem && badgeText) {
      ...
      const newTitle = titleForDueDate(due, dueComplete);
      ...
      badgeElem.classList.replace(oldClass, classForDueDate(due, dueComplete));
  ...
  updateCheckItemsEarliestDue() {
    ...
    if ($badgeElem) {
      ...
      if (checkItemsEarliestDue) {
        $badgeElem.addClass(classForDueDate(checkItemsEarliestDue, false));
      }
    }
