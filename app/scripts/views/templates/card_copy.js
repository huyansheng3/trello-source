  ...
  return t.mustacheBlockInverted('loading', () =>
    t.form(function () {
      ...
      t.mustacheBlock('hasStuff', function () {
        ...
        if (featureFlagClient.get('ecosystem.copy-custom-fields', false)) {
          t.mustacheBlock('hasCustomFields', () =>
            t.div('.check-div.u-clearfix', function () {
              t.input({
              ...
              return t.label({ for: 'idKeepCustomFields' }, () =>
                t.format('custom-fields-numcfs', {
                  numCustomFields: t.mustacheVar('numCustomFields'),
                }),
              );
            }),
          );
