      ...
      return t.div(
        ...
        () => {
          t.div('.member-container', () => {
            ...
            if (source === Source.SLACK && isInviteFromSlackExperiment) {
              t.div('.main-slack-component-icon', () => {
                return t.div(() =>
                  t.createElement(InviteFromSlackInfoTooltip, {
                    tooltipType: source,
                    idBoard,
                  }),
                );
