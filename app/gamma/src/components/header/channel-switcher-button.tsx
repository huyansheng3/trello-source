...
export const ChannelSwitcherButton: FunctionComponent<ChannelSwitcherButtonProps> = ({
  ...
  const ChannelSwitcherPopover = useLazyComponent(
    () =>
      import(
        /* webpackChunkName: "channel-switcher-popover" */ 'app/src/components/ChannelSwitcherPopover'
      ),
    { preload: showButton, namedImport: 'ChannelSwitcherPopover' },
  );

  const FeatureFlagList = useLazyComponent(
    () =>
      import(
        /* webpackChunkName: "feature-flag-list" */ 'app/src/components/ChannelSwitcherPopover'
      ),
  ...
  const HydraChooser = useLazyComponent(
    () =>
      import(
        /* webpackChunkName: "header-hydra-chooser" */ 'app/src/components/Header/HydraChooser'
      ),
    { preload: popoverProps.isVisible, namedImport: 'HydraChooser' },
  );
