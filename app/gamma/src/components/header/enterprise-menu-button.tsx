...
export const EnterpriseMenuButton: FunctionComponent<EnterpriseMenuButtonProps> = ({
  redesign,
}) => {
  const EnterpriseMenu = useLazyComponent(
    () =>
      import(
        /* webpackChunkName: "header-enterprise-menu" */ 'app/src/components/Header/EnterpriseMenu'
      ),
    {
      namedImport: 'EnterpriseMenu',
      preload: false,
    },
  );
