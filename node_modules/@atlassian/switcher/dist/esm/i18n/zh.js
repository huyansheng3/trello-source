...
export default {
  ...
  'fabric.atlassianSwitcher.errorTextLoggedOut': '重新登录以便使用 Atlassian 切换器。',
  'fabric.atlassianSwitcher.errorTextNetwork': '无法加载此列表。请重新加载页面，然后重试。',
  'fabric.atlassianSwitcher.errorTextUnverified': '请确认您的电子邮件地址以查看可用产品列表。',
  ...
  'fabric.atlassianSwitcher.sign.up.to.join.body': '要加入 {productLabel}，请使用您的电子邮件地址 {email} 创建Atlassian 帐户，如果已经拥有帐户，则可以直接登录。',
  ...
  'fabric.atlassianSwitcher.slackIntegrationLinkDescription': '将 Slack 与您的 Atlassian 产品集成',
  ...
  'fabric.atlassianSwitcher.trello.has.new.freinds.body': '现在，您可以在 Trello 这里快速找到其他 Atlassian 产品。如果您决定试用某个产品，我们将帮助您设置 Atlassian 帐户。',
