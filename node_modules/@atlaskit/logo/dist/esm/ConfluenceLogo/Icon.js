...
export var ConfluenceIcon = /*#__PURE__*/function (_Component) {
  _inherits(ConfluenceIcon, _Component);

  var _super = _createSuper(ConfluenceIcon);
...
_defineProperty(ConfluenceIcon, "defaultProps", _objectSpread(_objectSpread({}, DefaultProps), {}, {
  label: 'Confluence'
}));